...
export const programBuilderSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      description:
        "Это описание будет использоваться на общей странице всех программ",
      type: "text",
      validation: (Rule) => Rule.required(),
    }),
    defineField({
      ...
      description:
        "Это описание будет использоваться как основное описание программы на странице самой программы",
      type: "text",
      validation: (Rule) => Rule.required(),
    }),
    defineField({
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          description:
            "Данное изображение будет использовано в виджете программ, только PNG картинки без заднего фона",
          type: "image",
          options: {
            accept: "image/png",
            hotspot: true,
    ...
    defineField({
      ...
      validation: (Rule) =>
        Rule.required().error("Страница не может быть пустой"),
    }),
    defineField({
      name: "slug",
      title: "URL-адрес",
