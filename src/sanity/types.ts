...
// Query: {  "hero": *[_type == "hero" && language == $language][0] {    _id,    _type,    _createdAt,    _updatedAt,    language,    slogan  },  "about": *[_type == "about" && language == $language][0] {    _id,    _type,    _createdAt,    _updatedAt,    language,    description,    callToAction,    cards[] {      _key,      _type,      title,      description,      image {        asset-> {          _id,          url,          metadata {            dimensions,            lqip,            palette          }        },        hotspot,        crop      }    },    slogan  },  "promo": *[_type == "promo" && language == $language][0] {    _id,    _type,    _createdAt,    _updatedAt,    language,    slogan,    isActive  },  "slogan": *[_type == "slogan" && language == $language][0] {    _id,    _type,    _createdAt,    _updatedAt,    language,    slogan  },  "reviews": *[_type == "reviews" && language == $language][0] {    _id,    _type,    _createdAt,    _updatedAt,    language,    description,    reviews[]-> {      _id,      _type,      language,      person {        name,        surname,        occupation,        avatar {          asset-> {            _id,            url,            metadata {              dimensions,              lqip,              palette            }          },          hotspot,          crop        }      },      rating,      text    }  }}
...
// Query: *[_type == "settings" && language == $language][0] {  _id,  _type,  _createdAt,  _updatedAt,  language,  globalCtas,  seo,  contact,  analytics}
