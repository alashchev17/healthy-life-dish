...
export function getButtonStyles({
  ...
  // Base styles
  const baseStyles =
    "font-jura font-bold text-[16px] lg:text-[20px] leading-[90%] uppercase transition-all duration-200 ease-in-out disabled:cursor-not-allowed cursor-pointer";
  ...
  let sizeStyles =
    "text-base min-h-auto lg:min-h-[48px] py-4 px-4 lg:py-6 lg:px-9";
  ...
  switch (variant) {
    ...
    case "secondary":
      ...
      if (disabled) {
        variantStyles =
          "border-[3px] rounded-[24px] border-light-gray text-light-gray cursor-not-allowed pointer-events-none";
      }
      break;
    case "special-light":
      variantStyles =
