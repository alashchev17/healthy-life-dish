...
export const Header: FC = () => {
  ...
  return (
    <header ref={headerRef} className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-sm">
      <Container className="py-6">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 hidden md:flex items-center gap-10">
            <Link href="/services" className="text-green-acid transition-colors">
