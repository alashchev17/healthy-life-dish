...
export const Typography: FC<TypographyProps> = ({ children, variant = 'body', as, className = '', ...props }) => {
  ...
  return (
    <ElementTag className={`${cssStyles.typographyBase} ${combinedClassName}`} style={{ ...props.style }} {...props}>
      {children}
    </ElementTag>
  )
}
